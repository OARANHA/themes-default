# Aivopro Default Theme

This repository contains the source code of Aivopro's default theme that comes pre-built and embedded with the main Aivopro software. As a licensed user, you have access to this source code and can either:
...
An open source default theme for Aivopro built with [a modern theme development starter kit for Aivopro](https://github.com/aivopro/themes-starter), using Vite.js for asset building and Twig for templating. This project compiles into a PHP Composer package that integrates with Aivopro's theming system.
...
- Composer (for package installation in Aivopro)
- Running Aivopro installation
- Basic knowledge of:
...
3. **Set Up Environment**
   ...
   # Aivopro server URL (required for development)
...
6. **Configure Aivopro**
   ...
   Add or update these settings in your Aivopro's `.env` file:
...
8. **Activate Your Theme**
   ...
   a. Log into Aivopro admin panel
...
9. **Verify Development Setup**
   ...
   - [ ] Theme visible in Aivopro admin
...
1. Duplicate the default theme located at `/extra/extensions/aivopro/default` to a new location within `/extra/extensions/`, e.g., `/extra/extensions/yourorganization/themename`
